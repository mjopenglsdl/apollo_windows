...
#define AINFO ALOG_MODULE(MODULE_NAME, INFO1)
#define AWARN ALOG_MODULE(MODULE_NAME, WARN1)
#define AERROR ALOG_MODULE(MODULE_NAME, ERROR1)
#define AFATAL ALOG_MODULE(MODULE_NAME, FATAL1)
...
#define ALOG_MODULE_STREAM_INFO1  ALOG_MODULE_STREAM_INFO    
#define ALOG_MODULE_STREAM_WARN1  ALOG_MODULE_STREAM_WARN  
#define ALOG_MODULE_STREAM_ERROR1 ALOG_MODULE_STREAM_ERROR   
#define ALOG_MODULE_STREAM_FATAL1 ALOG_MODULE_STREAM_FATAL      
