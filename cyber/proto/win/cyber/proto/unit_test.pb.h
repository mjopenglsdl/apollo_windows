...
PROTOBUF_NAMESPACE_OPEN
template<> ::apollo::cyber::proto::Chatter* CYBER_API Arena::CreateMaybeMessage<::apollo::cyber::proto::Chatter>(Arena*);
template<> ::apollo::cyber::proto::ChatterBenchmark* CYBER_API Arena::CreateMaybeMessage<::apollo::cyber::proto::ChatterBenchmark>(Arena*);
template<> ::apollo::cyber::proto::UnitTest* CYBER_API Arena::CreateMaybeMessage<::apollo::cyber::proto::UnitTest>(Arena*);
PROTOBUF_NAMESPACE_CLOSE
namespace apollo {
namespace cyber {
namespace proto {
