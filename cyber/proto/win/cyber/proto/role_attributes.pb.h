...
CYBER_API extern RoleAttributesDefaultTypeInternal _RoleAttributes_default_instance_;
class SocketAddr;
class SocketAddrDefaultTypeInternal;
CYBER_API extern SocketAddrDefaultTypeInternal _SocketAddr_default_instance_;
}  // namespace proto
}  // namespace cyber
}  // namespace apollo
PROTOBUF_NAMESPACE_OPEN
template<> ::apollo::cyber::proto::RoleAttributes* CYBER_API Arena::CreateMaybeMessage<::apollo::cyber::proto::RoleAttributes>(Arena*);
template<> ::apollo::cyber::proto::SocketAddr* CYBER_API Arena::CreateMaybeMessage<::apollo::cyber::proto::SocketAddr>(Arena*);
PROTOBUF_NAMESPACE_CLOSE
namespace apollo {
namespace cyber {
namespace proto {
...
class CYBER_API RoleAttributes :
