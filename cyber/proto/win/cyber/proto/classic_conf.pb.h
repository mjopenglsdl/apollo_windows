...
PROTOBUF_NAMESPACE_OPEN
template<> ::apollo::cyber::proto::ClassicConf* CYBER_API Arena::CreateMaybeMessage<::apollo::cyber::proto::ClassicConf>(Arena*);
template<> ::apollo::cyber::proto::ClassicTask* CYBER_API Arena::CreateMaybeMessage<::apollo::cyber::proto::ClassicTask>(Arena*);
template<> ::apollo::cyber::proto::SchedGroup* CYBER_API Arena::CreateMaybeMessage<::apollo::cyber::proto::SchedGroup>(Arena*);
PROTOBUF_NAMESPACE_CLOSE
namespace apollo {
namespace cyber {
namespace proto {
...
class SchedGroup :
 ...
 private:
  ...
  public:
  static ::PROTOBUF_NAMESPACE_ID::internal::ExplicitlyConstructed<std::string> _i_give_permission_to_break_this_code_default_name_;
  private:
  ::PROTOBUF_NAMESPACE_ID::internal::ArenaStringPtr name_;
...
inline void SchedGroup::clear_processor_policy() {
  processor_policy_.ClearToEmptyNoArena(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited());
...
inline void SchedGroup::_internal_set_processor_policy(const std::string& value) {
  _has_bits_[0] |= 0x00000008u;
  processor_policy_.SetNoArena(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(), value);
}
...
inline void SchedGroup::set_processor_policy(const char* value) {
  GOOGLE_DCHECK(value != nullptr);
  _has_bits_[0] |= 0x00000008u;
  processor_policy_.SetNoArena(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(), ::std::string(value));
...
inline void SchedGroup::set_processor_policy(const char* value, size_t size) {
  _has_bits_[0] |= 0x00000008u;
  processor_policy_.SetNoArena(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(),
      ::std::string(reinterpret_cast<const char*>(value), size));
...
inline std::string* SchedGroup::_internal_mutable_processor_policy() {
  _has_bits_[0] |= 0x00000008u;
  return processor_policy_.MutableNoArena(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited());
}
inline std::string* SchedGroup::release_processor_policy() {
  ...
  _has_bits_[0] &= ~0x00000008u;
  return processor_policy_.ReleaseNonDefaultNoArena(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited());
}
inline void SchedGroup::set_allocated_processor_policy(std::string* processor_policy) {
  ...
  processor_policy_.SetAllocatedNoArena(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(), processor_policy);
