...
static bool descriptor_table_cyber_2fproto_2fperf_5fconf_2eproto_initialized = false;
const ::PROTOBUF_NAMESPACE_ID::internal::DescriptorTable descriptor_table_cyber_2fproto_2fperf_5fconf_2eproto = {
  &descriptor_table_cyber_2fproto_2fperf_5fconf_2eproto_initialized, descriptor_table_protodef_cyber_2fproto_2fperf_5fconf_2eproto, "cyber/proto/perf_conf.proto", 196,
...
static bool dynamic_init_dummy_cyber_2fproto_2fperf_5fconf_2eproto = (  ::PROTOBUF_NAMESPACE_ID::internal::AddDescriptors(&descriptor_table_cyber_2fproto_2fperf_5fconf_2eproto), true);
namespace apollo {
namespace cyber {
namespace proto {
