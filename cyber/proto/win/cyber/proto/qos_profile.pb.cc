...
static bool descriptor_table_cyber_2fproto_2fqos_5fprofile_2eproto_initialized = false;
const ::PROTOBUF_NAMESPACE_ID::internal::DescriptorTable descriptor_table_cyber_2fproto_2fqos_5fprofile_2eproto = {
  &descriptor_table_cyber_2fproto_2fqos_5fprofile_2eproto_initialized, descriptor_table_protodef_cyber_2fproto_2fqos_5fprofile_2eproto, "cyber/proto/qos_profile.proto", 656,
...
static bool dynamic_init_dummy_cyber_2fproto_2fqos_5fprofile_2eproto = (  ::PROTOBUF_NAMESPACE_ID::internal::AddDescriptors(&descriptor_table_cyber_2fproto_2fqos_5fprofile_2eproto), true);
namespace apollo {
namespace cyber {
namespace proto {
    ...
    switch (tag >> 3) {
      ...
      case 3:
        if (PROTOBUF_PREDICT_TRUE(static_cast<::PROTOBUF_NAMESPACE_ID::uint8>(tag) == 24)) {
          ...
          mps_ = ::PROTOBUF_NAMESPACE_ID::internal::ReadVarint(&ptr);
          CHK_(ptr);
        } else goto handle_unusual;
        continue;
...
::PROTOBUF_NAMESPACE_ID::uint8* QosProfile::InternalSerializeWithCachedSizesToArray(
