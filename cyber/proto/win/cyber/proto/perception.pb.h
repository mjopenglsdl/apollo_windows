...
PROTOBUF_NAMESPACE_OPEN
template<> ::apollo::cyber::proto::Perception* CYBER_API Arena::CreateMaybeMessage<::apollo::cyber::proto::Perception>(Arena*);
template<> ::apollo::cyber::proto::Perception_Header* CYBER_API Arena::CreateMaybeMessage<::apollo::cyber::proto::Perception_Header>(Arena*);
PROTOBUF_NAMESPACE_CLOSE
namespace apollo {
namespace cyber {
namespace proto {
