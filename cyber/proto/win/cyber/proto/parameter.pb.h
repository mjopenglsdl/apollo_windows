...
PROTOBUF_NAMESPACE_OPEN
template<> ::apollo::cyber::proto::BoolResult* CYBER_API Arena::CreateMaybeMessage<::apollo::cyber::proto::BoolResult>(Arena*);
template<> ::apollo::cyber::proto::NodeName* CYBER_API Arena::CreateMaybeMessage<::apollo::cyber::proto::NodeName>(Arena*);
template<> ::apollo::cyber::proto::Param* CYBER_API Arena::CreateMaybeMessage<::apollo::cyber::proto::Param>(Arena*);
template<> ::apollo::cyber::proto::ParamName* CYBER_API Arena::CreateMaybeMessage<::apollo::cyber::proto::ParamName>(Arena*);
template<> ::apollo::cyber::proto::Params* CYBER_API Arena::CreateMaybeMessage<::apollo::cyber::proto::Params>(Arena*);
PROTOBUF_NAMESPACE_CLOSE
namespace apollo {
namespace cyber {
namespace proto {
