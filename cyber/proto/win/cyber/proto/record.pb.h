...
PROTOBUF_NAMESPACE_OPEN
template<> ::apollo::cyber::proto::Channel* CYBER_API Arena::CreateMaybeMessage<::apollo::cyber::proto::Channel>(Arena*);
template<> ::apollo::cyber::proto::ChannelCache* CYBER_API Arena::CreateMaybeMessage<::apollo::cyber::proto::ChannelCache>(Arena*);
template<> ::apollo::cyber::proto::ChunkBody* CYBER_API Arena::CreateMaybeMessage<::apollo::cyber::proto::ChunkBody>(Arena*);
template<> ::apollo::cyber::proto::ChunkBodyCache* CYBER_API Arena::CreateMaybeMessage<::apollo::cyber::proto::ChunkBodyCache>(Arena*);
template<> ::apollo::cyber::proto::ChunkHeader* CYBER_API Arena::CreateMaybeMessage<::apollo::cyber::proto::ChunkHeader>(Arena*);
template<> ::apollo::cyber::proto::ChunkHeaderCache* CYBER_API Arena::CreateMaybeMessage<::apollo::cyber::proto::ChunkHeaderCache>(Arena*);
template<> ::apollo::cyber::proto::Header* CYBER_API Arena::CreateMaybeMessage<::apollo::cyber::proto::Header>(Arena*);
template<> ::apollo::cyber::proto::Index* CYBER_API Arena::CreateMaybeMessage<::apollo::cyber::proto::Index>(Arena*);
template<> ::apollo::cyber::proto::SingleIndex* CYBER_API Arena::CreateMaybeMessage<::apollo::cyber::proto::SingleIndex>(Arena*);
template<> ::apollo::cyber::proto::SingleMessage* CYBER_API Arena::CreateMaybeMessage<::apollo::cyber::proto::SingleMessage>(Arena*);
PROTOBUF_NAMESPACE_CLOSE
namespace apollo {
namespace cyber {
namespace proto {
