...
PROTOBUF_NAMESPACE_OPEN
template<> ::apollo::cyber::proto::ChoreographyConf* CYBER_API Arena::CreateMaybeMessage<::apollo::cyber::proto::ChoreographyConf>(Arena*);
template<> ::apollo::cyber::proto::ChoreographyTask* CYBER_API Arena::CreateMaybeMessage<::apollo::cyber::proto::ChoreographyTask>(Arena*);
PROTOBUF_NAMESPACE_CLOSE
namespace apollo {
namespace cyber {
namespace proto {
