...
CYBER_API extern QosProfileDefaultTypeInternal _QosProfile_default_instance_;
}  // namespace proto
}  // namespace cyber
}  // namespace apollo
PROTOBUF_NAMESPACE_OPEN
template<> ::apollo::cyber::proto::QosProfile* CYBER_API Arena::CreateMaybeMessage<::apollo::cyber::proto::QosProfile>(Arena*);
PROTOBUF_NAMESPACE_CLOSE
namespace apollo {
namespace cyber {
namespace proto {
...
bool CYBER_API QosHistoryPolicy_IsValid(int value);
...
CYBER_API bool QosReliabilityPolicy_IsValid(int value);
...
CYBER_API bool QosDurabilityPolicy_IsValid(int value);
