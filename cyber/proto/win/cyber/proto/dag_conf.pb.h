...
PROTOBUF_NAMESPACE_OPEN
template<> ::apollo::cyber::proto::ComponentInfo* CYBER_API Arena::CreateMaybeMessage<::apollo::cyber::proto::ComponentInfo>(Arena*);
template<> ::apollo::cyber::proto::DagConfig* CYBER_API Arena::CreateMaybeMessage<::apollo::cyber::proto::DagConfig>(Arena*);
template<> ::apollo::cyber::proto::ModuleConfig* CYBER_API Arena::CreateMaybeMessage<::apollo::cyber::proto::ModuleConfig>(Arena*);
template<> ::apollo::cyber::proto::TimerComponentInfo* CYBER_API Arena::CreateMaybeMessage<::apollo::cyber::proto::TimerComponentInfo>(Arena*);
PROTOBUF_NAMESPACE_CLOSE
namespace apollo {
namespace cyber {
namespace proto {
