...
PROTOBUF_NAMESPACE_OPEN
template<> ::apollo::cyber::proto::InnerThread* CYBER_API Arena::CreateMaybeMessage<::apollo::cyber::proto::InnerThread>(Arena*);
template<> ::apollo::cyber::proto::SchedulerConf* CYBER_API Arena::CreateMaybeMessage<::apollo::cyber::proto::SchedulerConf>(Arena*);
PROTOBUF_NAMESPACE_CLOSE
namespace apollo {
namespace cyber {
namespace proto {
