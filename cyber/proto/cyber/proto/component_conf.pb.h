...
PROTOBUF_NAMESPACE_OPEN
template<> ::apollo::cyber::proto::ComponentConfig* CYBER_API Arena::CreateMaybeMessage<::apollo::cyber::proto::ComponentConfig>(Arena*);
template<> ::apollo::cyber::proto::ReaderOption* CYBER_API Arena::CreateMaybeMessage<::apollo::cyber::proto::ReaderOption>(Arena*);
template<> ::apollo::cyber::proto::TimerComponentConfig* CYBER_API Arena::CreateMaybeMessage<::apollo::cyber::proto::TimerComponentConfig>(Arena*);
PROTOBUF_NAMESPACE_CLOSE
namespace apollo {
namespace cyber {
namespace proto {
