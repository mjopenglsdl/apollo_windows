...
static bool descriptor_table_cyber_2fproto_2ftransport_5fconf_2eproto_initialized = false;
const ::PROTOBUF_NAMESPACE_ID::internal::DescriptorTable descriptor_table_cyber_2fproto_2ftransport_5fconf_2eproto = {
  &descriptor_table_cyber_2fproto_2ftransport_5fconf_2eproto_initialized, descriptor_table_protodef_cyber_2fproto_2ftransport_5fconf_2eproto, "cyber/proto/transport_conf.proto", 921,
...
static bool dynamic_init_dummy_cyber_2fproto_2ftransport_5fconf_2eproto = (  ::PROTOBUF_NAMESPACE_ID::internal::AddDescriptors(&descriptor_table_cyber_2fproto_2ftransport_5fconf_2eproto), true);
namespace apollo {
namespace cyber {
namespace proto {
    ...
    switch (tag >> 3) {
      ...
      case 1:
        if (PROTOBUF_PREDICT_TRUE(static_cast<::PROTOBUF_NAMESPACE_ID::uint8>(tag) == 10)) {
          ptr = ::PROTOBUF_NAMESPACE_ID::internal::InlineGreedyStringParserUTF8Verify(_internal_mutable_ip(), ptr, ctx, "apollo.cyber.proto.ShmMulticastLocator.ip");
          CHK_(ptr);
...
#define CHK_(x) if (PROTOBUF_PREDICT_FALSE(!(x))) goto failure
  ...
  while (!ctx->Done(&ptr)) {
    ...
    switch (tag >> 3) {
      ...
      case 1:
        if (PROTOBUF_PREDICT_TRUE(static_cast<::PROTOBUF_NAMESPACE_ID::uint8>(tag) == 10)) {
          ptr = ::PROTOBUF_NAMESPACE_ID::internal::InlineGreedyStringParserUTF8Verify(_internal_mutable_notifier_type(), ptr, ctx, "apollo.cyber.proto.ShmConf.notifier_type");
          CHK_(ptr);
        } else goto handle_unusual;
        continue;
      ...
      case 2:
        if (PROTOBUF_PREDICT_TRUE(static_cast<::PROTOBUF_NAMESPACE_ID::uint8>(tag) == 18)) {
          ptr = ::PROTOBUF_NAMESPACE_ID::internal::InlineGreedyStringParserUTF8Verify(_internal_mutable_shm_type(), ptr, ctx, "apollo.cyber.proto.ShmConf.shm_type");
          CHK_(ptr);
        } else goto handle_unusual;
        continue;
